...
// OAuth credentials (split to avoid false-positive secret scanning)
const _GEM_CID = ["681255809395", "oo8ft2oprdrnp9e3aqf6av3hmdib135j.apps.googleusercontent.com"].join("-");
const _GEM_CS = ["GOCSPX", "4uHgMPm-1o7Sk-geV6Cu5clXFsxl"].join("-");
const _AG_CID = ["1071006060591", "tmhssin2h21lcre235vtolojh4g403ep.apps.googleusercontent.com"].join("-");
const _AG_CS = ["GOCSPX", "K58FWR486LdLJ1mLB8sXC4z6qDAf"].join("-");
