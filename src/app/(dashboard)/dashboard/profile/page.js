      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                <h2 className="text-lg sm:text-base font-semibold">Local Mode</h2>
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base sm:text-sm font-medium">Security</h3>
          </div>
        ...
        <Card>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-base sm:text-sm font-medium">OIDC Dashboard Login</h3>
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base sm:text-sm font-medium">Routing Strategy</h3>
          </div>
          <div className="flex flex-col gap-4">
            <div className="flex items-start sm:items-center justify-between gap-4">
              <div className="flex-1 min-w-0">
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base sm:text-sm font-medium">Network</h3>
          </div>
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base sm:text-sm font-medium">Observability</h3>
          </div>
          <div className="flex items-start sm:items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
