    ...
    <>
      <div className="relative" ref={menuRef}>
        <button
          ...
          className="flex items-center justify-center size-8 rounded-md text-text-muted hover:text-text-main hover:bg-surface-2 transition-colors"
          title="Menu"
        >
        ...
        {isOpen && (
          <div className="absolute right-0 top-full mt-2 w-60 bg-surface border border-border rounded-lg shadow-[var(--shadow-elev)] z-50 animate-in fade-in zoom-in-95 duration-150 overflow-hidden py-1">
            <MenuItem
              icon="history"
              label="Change Log"
