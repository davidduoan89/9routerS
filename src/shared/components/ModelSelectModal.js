              ...
              {filteredCombos.map((combo) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      px-2 py-1 rounded-lg text-xs font-medium transition-all border hover:cursor-pointer flex items-center gap-1
                      ${isSelected
              ...
              {group.models.map((model) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      px-2 py-1 rounded-lg text-xs font-medium transition-all border hover:cursor-pointer
                      ${isPlaceholder
